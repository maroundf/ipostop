...
var ImageViewer = /** @class */ (function (_super) {
    ...
    function ImageViewer() {
        ...
        _this.width = 0;
        _this.height = 0;
        _this.styles = (0, image_viewer_style_1.default)(0, 0, 'transparent');
        ...
        _this.handleLayout = function (event) {
            if (event.nativeEvent.layout.width !== _this.width) {
                ...
                _this.styles = (0, image_viewer_style_1.default)(_this.width, _this.height, _this.props.backgroundColor || 'transparent');
                // 强制刷新
                _this.forceUpdate();
            ...
            switch (imageInfo.status) {
              ...
              <react_native_1.View style={_this.styles.loadingContainer}>{_this.props.loadingRender()}</react_native_1.View>
                ...
                case 'success':
                    ...
                    image.props.style = __assign(__assign(__assign({}, _this.styles.imageStyle), image.props.style), { width: width, height: height });
