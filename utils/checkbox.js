export default class CheckBox extends React.Component {
    ...
    _onPress() {
        if (!this.props.disabled) this.props.onPress(!this.props.checked);
    }
    render() {
        ...
        if (this.props.btnStyle)
            if (this.props.bicon) {
                ...
                let icnn;
                if (this.props.checked) { icnn = "check-square"; icns = icns.concat(this.props.sbtnStyle); txts = txts.concat(this.props.stxts); } else icnn = "square";
